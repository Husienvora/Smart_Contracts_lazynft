...
describe("NFT1155LazyMint", function () {
    ...
    const tokenUri =
        "https://gateway.pinata.cloud/ipfs/QmWycePdRyU2bR4tVtLanHjTqQD1N2eZt9FfkUgTxYAPGo"
    ...
    it("Should be possible to redeem NFT using signed voucher", async () => {
        ...
        expect(await ethers.provider.getBalance(nftLazyContract.address)).to.equal(
            BNtoBigInt(feeAmount)
        )
        assert.isTrue(
