...
contract NFT1155LazyMint is ERC1155, Ownable, AccessControl, ERC2981PerTokenRoyalties {
    ...
    function supportsInterface(
        bytes4 interfaceId
    ) public view virtual override(AccessControl, ERC1155, ERC2981) returns (bool) {
        return
    ...
    function redeemToken(
        ...
        require(
            msg.value >= (voucher.sellingPrice * voucher.quantity),
